...
Or using environment variables (for library configuration):

```bash
# Note: These are library-level configuration variables.
# In Overleaf, storage backends are configured at the project level.
